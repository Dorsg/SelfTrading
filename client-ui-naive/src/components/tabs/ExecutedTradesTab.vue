<template>
  ...
  const columnDefs = [
    ...
    { headerName: 'Order Type', field: 'order_type', sortable: true, filter: true },
    { headerName: 'Quantity', field: 'quantity', sortable: true, filter: true },
    { headerName: 'Price', field: 'price', sortable: true, filter: true },
    { headerName: 'Fill Time', field: 'fill_time', sortable: true, filter: 'agDateColumnFilter' },
  ...
  async function loadExecutedTrades() {
    ...
    if (executedTrades.value.length) executedTradesLastUpdate.value = executedTrades.value[0].fill_time
